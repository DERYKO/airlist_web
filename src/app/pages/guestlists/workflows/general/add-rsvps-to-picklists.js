...
function addRsvpsToPicklists(locale, Alert, SweetAlert, SelectBox, Picklists, $http) {
    return {
        key: 'add-rsvps-to-picklists',
            ...
            .then(() => {
                SelectBox.multiple(Picklists, {
                    ...
                    $http.post('picklists/rsvps', {
                        ...
                        Alert.success(locale.getString('sweetalerts.add_successful'), locale.getString('picklists.rsvps_added'));
