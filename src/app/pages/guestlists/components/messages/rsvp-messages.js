import templateUrl from './rsvp-messages.tpl.html';
import emailModalTemplate from './show-email-modal.tpl.html';

class RsvpMessagesCtrl {

    constructor(Message, $injector, Messages, $scope) {
        this.model = Message;
...
angular
    ...
    .component('rsvpMessages', {
        bindings: {
            rsvp: '<'
        },
        controller: RsvpMessagesCtrl,
        controllerAs: 'vm',
